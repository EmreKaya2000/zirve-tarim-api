...
| **E-04** | KDV dahil mi hariç mi                                           | **VARSAYIM:** Perakende → fiyatlar **KDV dahil** (`Product.taxIncluded = true`), KDV ters hesapla ayrıştırılır                  | **❌ Hâlâ açık.** SPEC §9.1 "KDV bilgisi opsiyonel olabilir" diyor, §11 ise `sales.taxTotal` alanını tanımlıyor. Dahil mi hariç mi söylenmiyor. **Tutar hesabının yönünü değiştiren en pahalı açık madde.**                                                                                                                                                             |
...
| **R-13**     | **KDV dahil/hariç kararı hâlâ yazılı değil (E-04)** — şartname §9.1 ile §11 arasında gerilim var | Yüksek     | Yüksek     | Sistem `sales.taxIncluded = true` varsayımıyla çalışıyor. Yanlışsa tüm tutar hesabının yönü ve geçmiş satış rakamları değişir. **Mağazadan/mali müşavirden yazılı onay alınmalı**; onaya kadar bu ayar üretimde değiştirilmemeli                                                                                                        |
...
1. ~~**S1'e başlamadan üç soruyu netleştirin:** maliyet yöntemi (E-02), `netProfit` tanımı (E-03),
   ...
   **Güncelleme (2026-07-29):** Öneri zamanında uygulanmadı, üç soruyla da kod yazıldı. Şartname
   ...
   ağırlıklı ortalama uygulanmadı (E-02, V-01). **KDV kararı hâlâ açık ve artık geriye dönük
   maliyeti var:** üretimde satış kaydı oluştuktan sonra değiştirilirse geçmiş tutarlar tutarsız
   kalır → R-13. Bu maddeyi kapatmak kalan en yüksek öncelikli iştir.
...
>
> **Sonuç: 25 doğrulandı, 18 aşıldı, 1 açık.**
>
...
>
> Tek açık madde **V-03 (KDV)** ve yüksek etkili → R-13.
...
| **V-03** | Ürün fiyatları **KDV dahil** (`taxIncluded = true`)             | **❌ Açık.** SPEC §9.1 "KDV bilgisi opsiyonel olabilir" diyor, dahil/hariç demiyor. Sistem `sales.taxIncluded = true` ayarıyla çalışıyor. **Yazılı onay bekliyor → R-13.**                                                                                                   |
...
| #     | Madde                                                                                                                                                                                                                                                                                                                                        | Tür        | Öncelik    |
| ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ---------- |
| 1     | **KDV dahil mi hariç mi** (E-04 / V-03 / R-13) — şartname §9.1 ile §11 arasında gerilim                                                                                                                                                                                                                                                      | Karar      | **Yüksek** |
